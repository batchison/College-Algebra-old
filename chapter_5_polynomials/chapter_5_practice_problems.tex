...
{\tmstrong{Objective: Classify each expression as one of the following and perform the necessary factorization over the real numbers:
...
{\tmstrong{Factor each expression completely over the real numbers, making certain to factor out a GCF whenever possible.}}\pp
