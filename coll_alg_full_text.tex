...
%\thispagestyle{empty}
\import{./chapter_1_linears/}{chapter_1_linears}

\chapter{Systems of Linear Equations}
\label{Systems of Linear Equations}
\import{./chapter_2_systems/}{chapter_2_systems}

\chapter{Quadratic Equations}
\label{Quadratic Equations}
\import{./chapter_3_quadratics/}{chapter_3_quadratics}

\chapter{Introduction to Functions}
\label{Introduction to Functions}
\import{./chapter_4_functions/}{chapter_4_functions}

\chapter{Polynomial Functions}
\label{Polynomial Functions}
\import{./chapter_5_polynomials/}{chapter_5_polynomials}

%\chapter{Rational Functions}
%\label{Rational Functions}
%\import{./chapter_6_rationals/}{chapter_6_rationals}
